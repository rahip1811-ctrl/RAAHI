...
import { IconChevronRight, IconNav } from "@/components/icons";
  ...
  return (
    <>
      {/* ── left control stack ── */}
        ...
        <Link href="/drive" className="btn-press pointer-events-auto flex items-center justify-center gap-2 rounded-xl border px-4 py-3 font-semibold" style={{ background: "var(--surface)", borderColor: "var(--brand)", color: "var(--brand-strong)", boxShadow: "var(--shadow-sm)" }}>
          <IconNav size={16} /> Start driving
        </Link>
      </div>
