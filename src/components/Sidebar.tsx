    ...
    >
      <Link href="/" className="mb-7 flex items-center gap-2.5 px-2">
        ...
        <div className="leading-tight">
          ...
          <div className="text-[0.65rem]" style={{ color: "var(--text-faint)" }}>
            Command Center
          </div>
        </div>
      </Link>
        ...
        {items.map(({ href, label, Icon }) => {
          ...
          return (
            <Link
              key={href}
              href={href}
              className="btn-press flex items-center gap-3 rounded-xl px-3 py-2.5 text-sm font-semibold"
              style={{
      ...
      <Link
        href="/app"
        className="btn-press mt-auto flex items-center justify-center gap-2 rounded-xl border px-3 py-2.5 text-sm font-semibold"
